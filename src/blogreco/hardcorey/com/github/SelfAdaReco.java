...
/*
 * SelfAdaReco can recommend a list of blogs based on the simMtx generated before
 * different simMtx's have different weights according the accuracy of their recommendation history
 * that's why it is called SelfAda(ptive)
 */
 ...
 */
	 ...
	 * its weight in weightList is assigned the average of weightList
	 * @param sim the new similarity matrix
	 */
